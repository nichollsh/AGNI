...
@testset "blake" begin
    ...
    hash_result = AGNI.phys.blake.hash_file(nonexistent_file)
    ...
    validity = AGNI.phys.blake.valid_file(temp_file)
    ...
    correct_hash = AGNI.phys.blake.hash_file(temp_file2)
    write(temp_file2 * ".chk", correct_hash)
    validity2 = AGNI.phys.blake.valid_file(temp_file2)
    @test validity2 == true
    ...
    validity3 = AGNI.phys.blake.valid_file(temp_file3)
