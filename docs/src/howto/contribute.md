...
* Before submitting, please ensure your changes are consistent with the existing codebase. These can also be viewed in the [API reference](@ref).
...
* Ask a question about how to use or contribute to AGNI on the [discussions page](https://github.com/nichollsh/AGNI/discussions) or contact [Harrison Nicholls](https://www.h-nicholls.space/) directly.
