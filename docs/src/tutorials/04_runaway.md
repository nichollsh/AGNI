# Pure steam runaway greenhouse, notebook
...
To follow this tutorial, run the Jupyter notebook located at [docs/notebooks/01_canonical-runaway.ipynb](https://github.com/nichollsh/AGNI/tree/main/docs/notebooks/01_canonical-runaway.ipynb)

Initially OLR increases with $T_s$, but as the condensing layer
