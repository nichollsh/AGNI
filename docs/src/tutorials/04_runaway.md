...
To follow this tutorial, run the Jupyter notebook located at [tutorials/01_canonical-runaway.ipynb](https://github.com/nichollsh/AGNI/tree/main/tutorials/01_canonical-runaway.ipynb)
