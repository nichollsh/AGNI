...
AGNI incorporates a simple ocean model. This is divided into two reservoirs for each condensable component:
* A 'primary' reservoir generated by condensation at the surface.
* A 'secondary' reservoir generated by rainout aloft that happens to reach the surface without evaporating.
